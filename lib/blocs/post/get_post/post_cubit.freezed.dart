...
abstract class $PostStateCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<Post> posts, ApiStatus status, String message});
}
...
class _$PostStateImpl implements _PostState {
  ...
  @override
  String toString() {
    return 'PostState(posts: $posts, status: $status, message: $message)';
  }
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(_posts), status, message);
